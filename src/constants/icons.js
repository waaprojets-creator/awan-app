...
export function IconCar({ size = 22, color = T.tx2, opacity = 1 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" opacity={opacity}>
...
export function IconMoto({ size = 22, color = T.tx2, opacity = 1 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" opacity={opacity}>
...
export function IconBike({ size = 22, color = T.tx2, opacity = 1 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" opacity={opacity}>
      <Circle cx="5" cy="17" r="3" stroke={color} strokeWidth="1.5" fill="none"/>
      <Circle cx="19" cy="17" r="3" stroke={color} strokeWidth="1.5" fill="none"/>
...
export function IconFoot({ size = 22, color = T.tx2, opacity = 1 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" opacity={opacity}>
...
export function IconTransit({ size = 22, color = T.tx2, opacity = 1 }) {
  return (
    <Svg width={size} height={size} viewBox="0 0 24 24" opacity={opacity}>
