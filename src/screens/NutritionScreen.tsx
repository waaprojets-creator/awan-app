    ...
    <Modal visible={visible} transparent animationType="fade">
      ...
      >
        ...
        >
          ...
          {!selected ? (
            <div className="p-6">
              <div className="flex flex-row items-center gap-3 bg-awan-bg border border-white/5 rounded-awan-xl px-4 py-3 mb-4">
              ...
              <FlatList
                ...
                renderItem={({ item }: { item: FoodEntry }) => (
                  ...
                  >
                    <div className="bg-white/5 border border-white/5 rounded-xl px-4 py-3 flex flex-row items-center justify-between">
                      ...
                      <div className="w-8 h-8 rounded-xl bg-awan-gold/15 border border-awan-gold/20 flex items-center justify-center">
            ...
            >
              <div className="flex flex-col gap-4">
                <div>
                  ...
                  <TextInput
                    className="bg-awan-bg border border-white/5 rounded-awan-xl px-5 py-4 text-sm font-bold text-awan-tx font-mono"
                    placeholder="100"
                    placeholderTextColor="#6C665E"
                    value={grams}
                ...
                <Touch
                  ...
                  className="h-10 bg-white/5 border border-white/10 rounded-awan-xl flex items-center justify-center"
                >
          ...
          {selected && (
            <div className="px-6 py-4 border-t border-white/5">
              <Touch
                onPress={handleSubmit}
                className="h-12 bg-awan-gold rounded-awan-xl flex items-center justify-center"
              >
                <span className="text-[10px] font-black text-black uppercase tracking-widest">
                  AJOUTER
                </span>
    ...
    <PageWrapper style={{ flex: 1, backgroundColor: 'transparent' }}>
      ...
      >
        <div className="px-6 pt-4 pb-4">
          <ScreenHeader tag="BODY · NUTRITION" title="VECTEUR NUTRITIF" />
        </div>
            ...
            {MEAL_TYPES.map((m) => {
              ...
              return (
                <Touch
                  ...
                  className={`px-2 py-3 rounded-xl border flex items-center justify-center ${
                    active
        ...
        <div className="px-6 mb-10">
          <Touch
            ...
            className="h-14 bg-awan-gold rounded-awan-xl flex items-center justify-center shadow-lg shadow-awan-gold/10"
          >
